		...
		<div id="page-wrapper">
			...
			<div class="form-three widget-shadow">
				<form class="form-horizontal" action="#" method="post">
					...
					<div class="form-group">
						<label for="focusedinput" class="col-sm-2 control-label">销售商品：</label>
						<div class="col-sm-8">
							笔记本电脑
						</div>
					</div>
					...
					<div class="form-group">
						<label for="inputPassword" class="col-sm-2 control-label">销售时间：</label>
						<div class="col-sm-8">
							2017-5-16
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword" class="col-sm-2 control-label">销售金额：</label>
						<div class="col-sm-8">
							4800
						</div>
					</div>
