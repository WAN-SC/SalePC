...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			...
			<h3 class="title1">退单处理 </h3>
			<div class="form-three widget-shadow">
				<form class="form-horizontal" action="addBackOrderForm" method="POST">
					<div class="form-group">
						<label for="focusedinput" class="col-sm-2 control-label">退单编号：</label>
						<div class="col-sm-8">
							<select style = "width: 40%;height: 35px;" name = "select">
								<c:forEach items="${ denu }" var="de" >
									<option value= "${ de }" >${ de } &nbsp;&nbsp;&nbsp;订单号</option>
								</c:forEach>
							</select>
						</div>
					</div>
					<div class="form-group">
						<label for="disabledinput" class="col-sm-2 control-label">退单原因：</label>
						<div class="col-sm-8">
							<input type="text" class="form-control1"  name = "yuanyin"  placeholder="退单原因">
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword" class="col-sm-2 control-label">顾客姓名：</label>
						<div class="col-sm-8">
							<input type="text" class="form-control1"  name = "clientname" id="inputPassword" placeholder="顾客姓名">
						</div>
					</div>
					<div class="form-group">
						<label for="txtarea1" class="col-sm-2 control-label">备注：</label>
						<div class="col-sm-8"><textarea name="txtarea1" id="txtarea1"  name = "text" cols="80" rows="6"></textarea></div>
					</div>
	...
	<script>
		$(function() {
		    var add = "<%=session.getAttribute("tishi")%>";
		    if( add =="yes" )
		    {
		    	alert( "退单信息添加成功！" );
		    }else if( add == "false" )
		    {
		    	alert( "Sorry，添加退单信息失败！" );
		    }else
		    {
