...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			...
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">仓库进出库记录</h3>
					<div class="bs-example widget-shadow" data-example-id="hoverable-table"> 
						<input type = "radio" name = "cang" value = "chucang" checked = "checked">&nbsp;&nbsp;出仓记录&nbsp;&nbsp;&nbsp;&nbsp;
						<input type = "radio" name = "cang" value = "jincang">&nbsp;&nbsp;进仓记录
						<br/><br/>
						<table class="table table-hover"> 
							...
							<tbody> 
								<tr> 
									...
									<td>原由</td> 
									<td>备注</td> 
									<td><a href ="ManagerInOutWarehouseLogInfo.jsp"><input type = "button" class = "smallbutton" value="详情" name= "info"/></a></td> 
								</tr>
								<tr> 
									<th>2</th>
									<td>仓库名称</td> 
