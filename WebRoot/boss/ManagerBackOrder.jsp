			...
			<div class="form-three widget-shadow">
				<form class="form-horizontal" action="#" method="post">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control1" id="focusedinput" placeholder="退单编号">
						</div>
					</div>
					<div class="form-group">
						<label for="disabledinput" class="col-sm-2 control-label">退单原因：</label>
						<div class="col-sm-8">
							<input type="text" class="form-control1"  placeholder="退单原因">
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword" class="col-sm-2 control-label">顾客姓名：</label>
						<div class="col-sm-8">
							<input type="text" class="form-control1" id="inputPassword" placeholder="顾客姓名">
						</div>
					</div>
					<div class="form-group">
						<label for="txtarea1" class="col-sm-2 control-label">备注：</label>
						<div class="col-sm-8"><textarea name="txtarea1" id="txtarea1" cols="80" rows="6"></textarea></div>
					</div>
