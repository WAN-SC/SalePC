...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    <SCRIPT type="text/JavaScript">
		function del(val){
		if(confirm("确定下架?")){
		window.location="../boss/delectAccessories?id="+val;
		return true;
		}else{
		return false;
		}
    ...
    <SCRIPT type="text/JavaScript">
		function upd(val){
		window.location="../boss/getA?id="+val;
		}
	</SCRIPT>
</head> 
				...
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="hoverable-table"> 
						<div class="add">
							...
							<input type="button" class="bigbutton" onclick="location.href='../boss/getFinisher'" value="成品机信息">
							<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<form action="../boss/addAccessories" method="GET">
										<div class="modal-body">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" name="coresnumber">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" name="mvideo">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" name="dimm">
												</div>
												<div class="form-group">
													<label for="message-text" class="control-label">主板版型:</label>
													<input type="text" class="form-control" name="lcd">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" name="videointerface">
												</div>
												<div class="form-group">
						...
						<form action="../boss/queryAccessories" method="GET">
							...
							根据型号：<input type="text" name="comm.c4"/><br><br>
							根据适用类型：<select name="type">
										<option></option>
										<option>台式机</option>
										<option>笔记本</option>
										<option>平板</option>
